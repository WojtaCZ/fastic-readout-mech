...
M2 metal inserts with the length of 3.5 mm and output diameter of 3.5 mm were used in the design. These need to be fitted into the top part as seen on the image bellow. For all the screws, an M2 hex head with the length of 20mm is considered.
